...
public class FileUploadController {
	...
	@GetMapping("/smnsh2/test/file-upload")
	...
	@GetMapping("/smnsh2/test/file-upload/files/{filename:.+}")
	@ResponseBody
	...
	@GetMapping(value = "/smnsh2/files/download/{fileId}")
	...
	@PostMapping("/smnsh2/test/file-upload")
