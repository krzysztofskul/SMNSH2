...
@Configuration
@EnableWebSecurity
public class Smnsh2SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			...
			.antMatchers("/smnsh", "/smnsh2").hasRole("{USER, ADMIN}")
			.antMatchers("/admin/**", "/smnsh/admin/**", "/smnsh2/admin/**").hasRole("ADMIN")
